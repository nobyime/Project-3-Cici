...
enum Direction    { STEADY, UP, DOWN, RIGHT, LEFT, 
                    UP_RIGHT, UP_LEFT, DOWN_RIGHT, DOWN_LEFT, BLOW, BURNING };
...
public:
    ...
    void freezeAnimationOnFirstFrame() { mCurrentFrameIndex = 0; mAnimationTime = 0.0f; mFrameSpeed = 0; }
    void unfreezeAnimation(int fps) { mFrameSpeed = fps; }
